...
* **[DECRYPT project](https://de-crypt.org/) ([publication](https://doi.org/10.1080/01611194.2020.1716410)):** as we have already alluded to it, the Decrypt project commissioned the development of TranscriptTool.
...
* **[Few-shot algorithm](https://github.com/dali92002/HTRbyMatching) ([publication](https://doi.org/10.48550/arXiv.2009.12577)):** is one of the image processing algorithms present in and integral to TranscriptTool.
* **Unsupervised image processing algorithms ([publication](https://doi.org/10.1145/3322905.3322920)):** are likewise present in and an integral part of TranscriptTool.
* **[CrypTool](https://www.cryptool.org/en/) ([publication](https://doi.org/10.3384/ecp188399), [book](https://ieeexplore.ieee.org/servlet/opac?bknumber=10361268)):** can make use of the plain-text transcription generated by the TranscriptTool to decrypt encrypted documents.
